...
# Ajuste de codificação para lidar com caracteres especiais
...
# Conexão com o novo banco de dados PostgreSQL
# As credenciais precisam ser as mesmas que você definiu no database.py
DB_HOST = "localhost"
