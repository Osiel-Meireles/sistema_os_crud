...
const categorias = [
  'CONFIGURAÇÃO', 'INSTALAÇÃO', 'MANUTENÇÃO', 'OUTROS', 'REDES'
]
...
export default function OSExterna() {
  ...
  const onSubmit = async (data: OSExternaForm) => {
    ...
    try {
      ...
      console.log('Dados da OS Externa:', data)
      ...
      alert('Erro ao registrar OS Externa')
    } finally {
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Ordem de Serviço Externa</h1>
          <p className="text-gray-600">Registre uma nova ordem de serviço externa</p>
        </div>
      </div>

      <div className="card">
        <div className="card-header">
          <h2 className="text-lg font-semibold text-gray-900">Nova OS Externa</h2>
        </div>
